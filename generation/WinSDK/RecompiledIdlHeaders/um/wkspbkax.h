...
EXTERN_C const IID IID_IWorkspaceBrokerAx;
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE LaunchWorkspaceItem( 
            ...
            _In_  BSTR WkspFolder,
            /* [annotation][in] */ 
            _In_  BSTR WkspItemName,
            /* [annotation][in] */ 
            _In_  BSTR ActivationContext) = 0;
