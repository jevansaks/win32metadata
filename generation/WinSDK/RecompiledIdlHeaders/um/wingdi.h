...
#pragma push_macro("FR_PRIVATE")
#pragma push_macro("FR_NOT_ENUM")
#undef FR_PRIVATE
#undef FR_NOT_ENUM
enum class FONT_RESOURCE_CHARACTERISTICS : unsigned int
{
    FR_PRIVATE = 0x10,
    FR_NOT_ENUM = 0x20,
};
#pragma pop_macro("FR_NOT_ENUM")
#pragma pop_macro("FR_PRIVATE")
#endif

_Windows_SupportedOS_Windows2000_
WINGDIAPI int WINAPI AddFontResourceExA(
    _In_ LPCSTR name,
    _In_ _Win32_AssociatedEnum_(FONT_RESOURCE_CHARACTERISTICS) DWORD fl,
    _Reserved_ PVOID res);
_Windows_SupportedOS_Windows2000_
WINGDIAPI int WINAPI AddFontResourceExW(
    _In_ LPCWSTR name,
    _In_ _Win32_AssociatedEnum_(FONT_RESOURCE_CHARACTERISTICS) DWORD fl,
    _Reserved_ PVOID res);
#ifdef UNICODE
