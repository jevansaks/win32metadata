...
| `ktmw32.h` | Fs | remaining |  |  |  |
| `libloaderapi.h` | Intl, LibraryLoader | remaining |  |  |  |
...
| `menutemplate.h` | MenuRc | remaining |  |  |  |
...
| `oledlg.h` | Com, Com.CallObj, Com.ChannelCreds, Com.Urlmon, ComOle, TransactionServer | remaining |  |  |  |
| `oleidl.h` | Com, Com.CallObj, Com.ChannelCreds, Com.Urlmon, ComOle, Shell, TransactionServer | remaining |  |  |  |
...
| `rometadata.h` | WinRT.Metadata | remaining |  |  |  |
...
| `setupapi.h` | DevInst, Setup | remaining |  |  |  |
| `sfc.h` | Setup | remaining |  |  |  |
| `shappmgr.h` | Shell | remaining |  |  |  |
