...
- **Partitions:** Fs
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the core file I/O
  API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/fileapi.h.set-last-error.patch`
