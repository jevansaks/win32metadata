...
- **Partitions:** Identity
- **Delta:** Retained artifact applies ABI-compatible semantic enum typing to the LSA
  sub-authentication constants declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/SubAuth.h.zz-crypto-security-enums.patch`
