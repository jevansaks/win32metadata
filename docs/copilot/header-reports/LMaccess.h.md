...
- **Partitions:** FileHistory, NetMgmt, WinProg
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the NetAPI
  user/group account management API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/LMaccess.h.set-last-error.patch`
