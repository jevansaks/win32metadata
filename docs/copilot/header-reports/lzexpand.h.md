...
- **Partitions:** Fs
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the legacy LZ
  file-compression API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/lzexpand.h.zzz-set-last-error.patch`
