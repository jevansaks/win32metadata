...
- **Partitions:** Snmp
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the SNMP extension
  agent API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/Snmp.h.set-last-error.patch`
