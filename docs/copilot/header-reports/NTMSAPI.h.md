...
- **Partitions:** Fs
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the Removable
  Storage Manager (NTMS) API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/NTMSAPI.h.zzz-set-last-error.patch`
