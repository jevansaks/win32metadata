...
- **Partitions:** Wes
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the Windows Event
  Log API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/winevt.h.service-security-set-last-error.patch`
