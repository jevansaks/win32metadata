...
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the Security
  Descriptor Definition Language (SDDL) conversion API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/sddl.h.service-security-set-last-error.patch`
