...
- **Batch:** `existing-patches-11`
- **Partitions:** DirectWrite
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  DirectWrite 3 API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/dwrite_3.h.zz-supported-os.patch`
