...
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  Shell Lightweight-Utility API surface (path/string/registry helpers) declared in this
  header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/Shlwapi.h.zzz-supported-os.patch`
