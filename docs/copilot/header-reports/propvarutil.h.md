...
- **Partitions:** Com.StructuredStorage, Variant
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  `PROPVARIANT` helper-function API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/propvarutil.h.zzz-supported-os.patch`
