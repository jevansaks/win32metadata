...
- **Partitions:** IpHlp
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the ICMP ping API
  surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/IcmpAPI.h.set-last-error.patch`
