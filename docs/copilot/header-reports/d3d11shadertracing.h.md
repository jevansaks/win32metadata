...
- **Partitions:** Direct3D11
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  Direct3D 11 shader-tracing API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/d3d11shadertracing.h.zz-supported-os.patch`
