...
- **Partitions:** ComOle, TransactionServer
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  COM+ transaction administration COM interface API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/MtxAdmin.h.zzz-supported-os.patch`
