...
- **Partitions:** Com.StructuredStorage, Properties, Shell
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  structured-storage property-set (`IPropertyStorage`) API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/PropIdl.h.zzz-supported-os.patch`
