...
- **Partitions:** CmpApi
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the compression API
  functions declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/compressapi.h.zzz-set-last-error.patch`
