...
- **Batch:** `existing-patches-29`
- **Partitions:** Properties, Shell
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  core Shell API surface (`ShellExecute`, `SHFileOperation`, notification icons, etc.)
  declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/shellapi.h.zzz-supported-os.patch`
