...
- **Delta:** Retained artifact applies ABI-compatible semantic enum typing to DirectShow
  control interface constants declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/control.h.zzz-multimedia-enums.patch`
