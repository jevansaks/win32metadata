...
- **Partitions:** DlgBox, Media, Media.KernelStreaming, Multimedia
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  common dialog API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/commdlg.h.zzz-supported-os.patch`
