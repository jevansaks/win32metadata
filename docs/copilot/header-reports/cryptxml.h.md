...
- **Batch:** `existing-patches-04`
- **Partitions:** Security.Cryptography, Security.Cryptography.UI
- **Delta:** Retained artifact applies ABI-compatible semantic enum typing to the XML
  signature/encryption constants declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/cryptxml.h.zz-crypto-security-enums.patch`
