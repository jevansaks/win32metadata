...
## Summary
Print Support App / Printer Extension COM interfaces
(`IPrinterExtensionEventCallback`, `IPrintWorkflowXpsDataAvailableEvent`,
etc.). All 567 callable declarations found are `STDMETHOD` COM vtable
