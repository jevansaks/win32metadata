...
- **Partitions:** Base, Com, Com.CallObj, Com.ChannelCreds, Com.StructuredStorage,
  Com.Urlmon, ComOle, FileHistory, IO, Printing, TransactionServer, VSS, WinProg
- **Delta:** Retained artifact adds `_Win32_metadata_supported_os_(...)` annotations to the
  core OLE/COM object-base API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/objbase.h.zzz-supported-os.patch`
