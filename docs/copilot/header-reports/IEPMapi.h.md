...
- **Delta:** Retained artifact adds `_Win32_metadata_import_library_(...)` annotations to
  the Internet Explorer protected-mode API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/IEPMapi.h.import-library-overrides.patch`
