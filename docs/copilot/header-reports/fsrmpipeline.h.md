...
## Summary
File Server Resource Manager (FSRM) pipeline module COM interfaces
(`IFsrmPipelineModuleDefinition`, `IFsrmPipelineModuleImplementation`,
etc.). All 544 callable declarations found are `STDMETHOD` COM vtable
