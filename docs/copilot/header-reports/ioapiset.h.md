...
- **Partitions:** Base, IO
- **Delta:** Retained artifact adds `_Win32_metadata_set_last_error_` to the I/O completion
  port API surface declared in this header.
- **Resolution:** No further changes needed; retained as-is.
- **Artifact:** `generation/WinSDK/patches/post-midl/ioapiset.h.set-last-error.patch`
