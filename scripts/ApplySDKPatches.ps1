...
#   e.g. wingdi.h.win32metadata.patch
#        amstream.idl.win32metadata.patch
# The shift-left migration keeps one consolidated patch per source header or IDL file.
...
#          > "generation/WinSDK/patches/<phase>/<file>.win32metadata.patch"
